    ...
    <div class="sidebar">
        ...
        <ul>
           ...
           <ul id="demo2" class="collapse text-center"  >
            ...
            <li><a href="Total.php"><i class="fas fa-address-card icon"></i>Appointment History</a></li>
      ...
      <a class="dropdown-item text-white" href="Changepassword.php">Change Password</a>
        ...
        <div class="header2">
         <h5>APPOINTMENT HISTORY</h5>
                ...
                <li class="breadcrumb-item"><a href="EditProfile.php">Appointment History </a></li>
